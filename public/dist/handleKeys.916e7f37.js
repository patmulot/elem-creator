...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/components/handleKeys.js":[function(require,module,exports) {
var handleKeys = {
  // =================== //
  // === PROPERTIES === //
  // ================= //
  ...
  // === METHODS === //
  // ============== //
  initKeysHandlers: function initKeysHandlers() {
  ...
  handlePressDown: function handlePressDown(evt) {
    // console.log(evt);
    if (evt.key === "Escape") {
  ...
  handlePressUp: function handlePressUp(evt) {
    handleKeys.holdCtrl = false;
    handleKeys.holdC = false;
    handleKeys.holdV = false;
  },
  checkCopyPaste: function checkCopyPaste() {
    var elemOrientation;
    var elemIndex = elements.elemToModify.dataset.indexNumber;
    ...
    if (handleKeys.holdCtrl === 1 && handleKeys.holdV === 1) {
      ...
      var newElement = elements.allElements["element-" + elements.lastElementCreated]; // setting copyied values to new element :
      ...
      newElement.style.backgroundColor = elements.elementToCopy.style.backgroundColor; // setting rotation value to new element :
      ...
      var centerElement = elements.elemToModify.querySelector(".center"); // setting round values to new element :
      ...
      elements.elemToModify.style.borderBottomLeftRadius = elements.elementToCopy.style.borderBottomLeftRadius; // setting round values to center element :
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/components/handleKeys.js"], null)
//# sourceMappingURL=/handleKeys.916e7f37.js.map