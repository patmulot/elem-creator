...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/components/handleMouse.js":[function(require,module,exports) {
...
var handleMouse = {
  ...
  // === METHODS === //
  // ============== //
  initMouseHandlers: function initMouseHandlers() {
    var elementContainer = document.querySelector(".elements_container");
    var clickableElement = document.querySelectorAll(".clickable"); // init mouse events :

    var _iterator = _createForOfIteratorHelper(clickableElement),
        _step;
    ...
    elementContainer.addEventListener("mousemove", handleMouse.handleMousemove); // ini keyboard events :
  ...
  handleElementClickdown: function handleElementClickdown(evt) {
    modifications.disableRound(); // setting element to modify from clicked element :
    ...
    elements.elementPosY = elements.elemToModify.offsetTop; // init element size :
    ...
    elements.elementHeight = elements.elemToModify.offsetHeight; // init cursor position :

    handleMouse.cursorPosX = evt.clientX;
    handleMouse.cursorPosY = evt.clientY; // starting hold click :

    handleMouse.holdClick = true;
    document.body.style.cursor = "all-scroll"; // selected element :
  ...
  handleElementClickup: function handleElementClickup(evt) {
    // reset elements clicked
    elements.elementClicked = false;
    modifications.elementModification = false;
    document.body.style.cursor = "auto"; // ending hold click :
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/components/handleMouse.js"], null)
//# sourceMappingURL=/handleMouse.d0965657.js.map